...
//=======
        //        con = new NpgsqlConnection(connString + ";DataBase = " + this.treeView1.SelectedNode.Text.ToString());
        //        con.Open();
        //    }
        //}
        /*delete table*/
        private void deleteDropToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                var cmd = new NpgsqlCommand("drop table " + treeView1.SelectedNode.Text + ";", tvc.Establishconnection(treeView1.SelectedNode));
                cmd.ExecuteNonQuery();
                treeView1.SelectedNode.Remove();
                this.Refresh();
            }
